...
class StuffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stuff" do
    assert_difference("Stuff.count") do
      post stuffs_url, params: { stuff: { category_id: @stuff.category_id, desc: @stuff.desc, name: @stuff.name } }
    end
  ...
  test "should update stuff" do
    patch stuff_url(@stuff), params: { stuff: { category_id: @stuff.category_id, desc: @stuff.desc, name: @stuff.name } }
